...
@CucumberOptions(features="@rerun:src\\test\\resources\\Rerun\\Failed.txt",glue="org.stepdefenition",dryRun=false,monochrome=true,
strict=false,snippets=SnippetType.CAMELCASE,tags= {"@sanity , @smoke"},plugin= {"usage","html:target\\Reports",
		...
		"json:target\\Reports\\fb.json","rerun:src\\test\\resources\\Rerun\\Failed.txt"})
